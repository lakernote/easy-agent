...
export const api = {
  ...
  createSession: (message: string, attachments: AttachmentInput[] = [], workspace = '', profileId = '', projectId = '') => request<Session>('/api/v1/sessions', { method: 'POST', body: JSON.stringify({ message, attachments, workspace, profileId, projectId }) }),

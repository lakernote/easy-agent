...
export function ProjectIcon() { return <svg className="project-icon" viewBox="0 0 24 24" aria-hidden="true"><path d="m6.2 8.7-.9-4 3.6 2.2a7 7 0 0 1 6.2 0l3.6-2.2-.9 4a6.7 6.7 0 0 1 1.2 3.8 7.1 7.1 0 1 1-14.2 0 6.7 6.7 0 0 1 1.4-3.8Z" /><circle cx="9.5" cy="12" r=".7" fill="currentColor" stroke="none" /><circle cx="14.5" cy="12" r=".7" fill="currentColor" stroke="none" /><path d="M11.1 14.1c.6.5 1.2.5 1.8 0m-2.6 1.4c.5.7 1.2 1 2.1 1s1.6-.3 2.1-1" /></svg> }

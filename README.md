<div align="center">
  ...
  <h1>EasyAgent</h1>
  <p>面向研发、测试和运维团队的自托管 AI Agent 工作台。</p>
  <p><strong>服务器长任务 · Git worktree 隔离 · EasyAgent / Codex · Skills / MCP · 可审计 Trace</strong></p>
</div>

## 解决什么问题

- **把长任务放到服务器**：代码修改、测试、发布检查和故障排查可持续运行，不占用个人电脑。
